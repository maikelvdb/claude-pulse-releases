...
export function StatusBar({
  ...
  if (isCompact && !isVertical) {
    return (
      <div
        className={`relative flex items-center gap-2 px-2 pr-6 bg-claude-bg border border-claude-border rounded-none shadow-lg h-[35px] transition-all duration-300`}
      >
